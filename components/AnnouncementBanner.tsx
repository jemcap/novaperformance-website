...
const AnnouncementBanner = () => {
  return (
    <div className="w-full flex flex-col md:flex-row bg-red-500 gap-4 md:gap-8 py-4 justify-center items-center">
      <h1 className="flex gap-2 text-base md:text-xl text-white z-[1] items-center">
        <MdEmojiEvents className="text-lg md:text-2xl" />
        <span>Nova Winter Meet</span>
      </h1>
      <h1 className="flex gap-2 text-base md:text-xl z-[1] items-center">
